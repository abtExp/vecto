...
function test_func(){
	...
	var arr = vect.Vector.add(new_vector_2,new_vector_2);
...
var new_vector_1 = new vect.Vector([2,3,4]);
test_creation(new_vector_1);
var new_vector_2 = vect.Vector.array([[[2,3,4],[1,5,7]],[[3,4,9],[0,6,8]]]);
test_creation(new_vector_2);
var new_vector_3= new vect.Vector([2,3],[[1,3,4],[2,5,7],[0,8,9]]);
test_creation(new_vector_3);
var new_vector_4 = vect.Vector.zeroes([2,2,3]);
