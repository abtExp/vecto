...
// /* Test for ndarray_object.transpose() */

// let cc = new ndarray([2,3],[],'float32');
// cc.arrange();
// console.log(cc.transpose());


// let a = [[0.12314214,0.224266,0.32536213],[0.4134151,0.53255135,0.632151]
// ,[0.72141,0.7124114,0.8234114],[0.94321412,0.231564379,0.62377722]];
// let b = [1,0,1];

// console.log(product(a,b,'dot'));

let a = [1,2,3,4,5,6];
console.log(core.arrange([2,3,3]));
